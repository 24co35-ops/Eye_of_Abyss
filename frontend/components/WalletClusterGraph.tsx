...
export function WalletClusterGraph({
  ...
  const handleExport = () => {
    ...
    a.href = png;
    a.download = "wallet_cluster_graph.png";
    a.click();
  };

  return (
    <div className="relative w-full h-[360px] bg-void border border-mist rounded-[4px] overflow-hidden select-none">
      {/* Top bar over graph */}
      <div className="absolute top-2.5 left-3 right-3 flex items-center justify-between z-10 pointer-events-none">
        <div className="bg-shadow/80 border border-mist px-2.5 py-1 rounded-[4px] text-[11px] font-mono text-text-secondary flex items-center gap-2">
        ...
        {/* Graph Controls */}
        <div className="flex items-center gap-1 pointer-events-auto bg-shadow border border-mist rounded-[4px] p-0.5">
          <button
